...
MUSTARD_MASH = Food("mustard_mash", "Mustard Mash", "dinner", ["dijon mustard", "wholegrain mustard", "potatoes", "cream"], 1)
POTATO_CURRY = Food("potato_curry", "Potato Curry", "dinner",["potatoes", "curry powder", "cream",
                                                     "tomatoes", "onions", "garlic", "four spice", "paprika", "ginger"], 2)
SALMON_PASTA = Food("salmon_pasta", "Salmon Pasta", "dinner",["salmon", "pasta", "cream", "onions", "nutmeg", "butter"], 1)
